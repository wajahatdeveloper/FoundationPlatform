...
public class PlayerPrefsX
{
    ...
    public static bool SetStringArray(String key, String[] stringArray)
    {
        ...
        // Use a local write index (byte 0 is the identifier) so concurrent/nested
        // operations on the shared static idx cannot corrupt this parse.
        var localIdx = 1;
        ...
        for (var i = 0; i < stringArray.Length; i++)
        {
            ...
            bytes[localIdx++] = (byte)stringArray[i].Length;
        }
    ...
    public static String[] GetStringArray(String key)
    {
        if (PlayerPrefs.HasKey(key))
        {
            ...
            // Use a local read index (byte 0 is the identifier) so concurrent/nested
            // operations on the shared static idx cannot corrupt this parse.
            var localIdx = 1;
            for (var i = 0; i < numberOfEntries; i++)
            {
                int stringLength = bytes[localIdx++];
