...
public static class RectExtensions
{
    ...
    {
        return src.xMax >= intersectsWith.xMin && src.xMin <= intersectsWith.xMax && src.yMax >= intersectsWith.yMin &&
               src.yMin <= intersectsWith.yMax;
    }
    ...
    {
        return new Rect(src.xMin - amount.x, src.yMin - amount.y, Mathf.Max(src.width + amount.x * 2f, 0f),
            Mathf.Max(src.height + amount.y * 2f, 0f));
    }
